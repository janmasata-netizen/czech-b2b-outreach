...
const steps = [
  ['Add lead_type column', `
    ALTER TABLE public.leads
      ADD COLUMN IF NOT EXISTS lead_type text NOT NULL DEFAULT 'company'
      CHECK (lead_type IN ('company', 'contact'));
  `],
...
console.log('Running contact-lead migration on cycapkswtucbucyegdsn...\n');
let ok = 0, fail = 0;
