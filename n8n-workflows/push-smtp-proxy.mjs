/**
 * push-smtp-proxy.mjs
 * Pushes updated WF8 + wf-force-send to n8n (deactivate -> PUT -> activate)
 * Replaces betterEmailSend with HTTP Request to smtp-proxy for proper threading headers
 */
...
async function main() {
  console.log('=== Push SMTP Proxy Fix (WF8 + Force Send) ===');
