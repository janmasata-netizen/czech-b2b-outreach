/**
 * push-wf7-response-fix.mjs
 * Pushes WF7 (Wave Schedule) with responseMode fix to n8n.
 * Changes webhook from onReceived to responseNode so the UI
 * gets the response only after wave status is set to "scheduled".
 */
...
async function main() {
  console.log('=== Push WF7: Wave Schedule (Response Mode Fix) ===');
